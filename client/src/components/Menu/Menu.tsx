  ...
  return (
    <div className="min-h-screen bg-[#1e1e1e] flex flex-col items-center relative">
      ...
      <div className="w-full max-w-5xl mt-6 mb-10">
        <MenuSection title="For Start" items={menuSection3} />
        <MenuSection title="Salads" items={menuSection2} />
        <MenuSection title="First" items={menuSection1} />
        <MenuSection title="Drinks" items={menuSection4} />
      </div>
    </div>
  );
};
